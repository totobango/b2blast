      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-10 pt-6 border-t border-gray-200 flex flex-col sm:flex-row justify-between gap-3">
          ...
          <div className="flex gap-4">
            <Link href={`/${locale}/privacy`} className="text-xs text-gray-400 hover:text-gray-600 transition-colors">{t.footer.links.privacy}</Link>
            <Link href={`/${locale}/legal`} className="text-xs text-gray-400 hover:text-gray-600 transition-colors">{t.footer.links.legal}</Link>
          </div>
        </div>
      </div>
    </footer>
