        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-32 sm:py-40">
          <div className="max-w-3xl">
            ...
            <div className="hero-animate hero-delay-5 mt-10 flex flex-col sm:flex-row gap-4">
              ...
              <Link href="/en/contact#calendly" className="inline-flex items-center justify-center rounded-lg border border-gray-700 px-7 py-4 text-base font-semibold text-gray-300 hover:border-brand/50 hover:text-white transition-all">{t.hero.ctaSecondary}</Link>
            </div>
          </div>
              ...
              <ScrollReveal key={pkg.name} delay={i * 120}>
                <TiltCard className={`relative rounded-2xl p-6 sm:p-8 h-full ${pkg.popular ? "bg-brand text-white ring-2 ring-brand-light shadow-xl shadow-brand/20" : "bg-white/[0.03] border border-white/10"}`} tiltAmount={3}>
                  <div className="flex flex-col h-full">
                    {pkg.popular && <span className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-white px-4 py-1 text-xs font-semibold text-brand shadow-lg z-10">Most Popular</span>}
            ...
            <div className="relative overflow-hidden rounded-3xl bg-black px-8 py-20 sm:px-16 sm:py-24 text-center">
              ...
              <div className="relative">
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  <Link href="/en/contact#calendly" className="inline-flex items-center rounded-lg border border-gray-700 px-8 py-4 text-base font-semibold text-gray-300 hover:border-brand/50 hover:text-white transition-all">{t.cta.buttonSecondary}</Link>
                </div>
              </div>
            </div>
          </ScrollReveal>
