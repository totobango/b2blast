        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-32 sm:py-40">
          <div className="max-w-4xl">
            <div className="hero-animate hero-delay-1 inline-flex items-center gap-2 rounded-full border border-brand/30 bg-brand/10 px-4 py-1.5 text-sm font-medium text-brand-light mb-8">
              ...
              B2B Only — Français ↔ Anglais
            </div>

            <h1 className="hero-animate hero-delay-2 font-heading fluid-h1 font-bold text-cream leading-[1.05]">
              Vos ads marchent chez vous.<br />
              <span className="text-gradient-brand">Elles échouent à l&apos;étranger.</span>
            </h1>

            <p className="hero-animate hero-delay-3 mt-8 text-lg sm:text-xl text-gray-400 max-w-2xl leading-relaxed">
              Mauvais ton, mauvais ciblage, mauvais signaux culturels — budget gaspillé. Je règle ça. Bilingue natif Français ↔ Anglais. Ex-LinkedIn, ex-Google.
            </p>
            ...
            <div className="hero-animate hero-delay-5 mt-10 flex flex-col sm:flex-row gap-4">
              <Link href="/fr/contact" className="btn-magnetic inline-flex items-center justify-center rounded-xl bg-brand px-8 py-4 text-base font-semibold text-white shadow-lg shadow-brand/25">
                {t.hero.cta}
              ...
              <Link href="/fr/contact#calendly" className="inline-flex items-center justify-center rounded-xl border border-white/10 px-8 py-4 text-base font-semibold text-gray-300 hover:border-brand/40 hover:text-white transition-all">
                {t.hero.ctaSecondary}
              </Link>
            </div>
          </div>
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand/20 via-surface-light to-surface-light px-8 py-20 sm:px-16 sm:py-28 text-center border border-brand/10">
              ...
              <div className="relative">
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                  <Link href="/fr/contact" className="btn-magnetic inline-flex items-center rounded-xl bg-brand px-8 py-4 text-base font-semibold text-white shadow-lg shadow-brand/25">
                    {t.cta.button}
                    <svg className="ml-2 h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>
                  </Link>
                  <Link href="/fr/contact#calendly" className="inline-flex items-center rounded-xl border border-white/10 px-8 py-4 text-base font-semibold text-gray-300 hover:border-brand/40 hover:text-white transition-all">
