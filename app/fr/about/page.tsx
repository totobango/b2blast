...
export const metadata: Metadata = {
  title: "À propos de Thomas Germain — Expert Ads B2B",
  description: "Expert paid ads B2B bilingue natif français/anglais. Ex-Google, ex-LinkedIn, ex-Pinterest. 6+ ans de gestion campagnes B2B en EMEA. Basé à Dublin.",
};
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-start gap-8">
            <div className="flex-shrink-0">
              <Image src="/images/thomas.jpg" alt="Thomas Germain — Fondateur de B2BLAST, expert paid ads B2B" width={160} height={160} priority className="rounded-full w-32 h-32 sm:w-40 sm:h-40 object-cover" />
            </div>
            <div>
              ...
              <a href={t.about.linkedin} target="_blank" rel="noopener noreferrer" className="mt-4 inline-flex items-center gap-2 text-sm font-medium text-brand hover:text-brand-light transition-colors">
